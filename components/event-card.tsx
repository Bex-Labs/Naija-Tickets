...
export function EventCard({ event }: { event: Event }) {
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-[#151b18]">
        <img
          src={event.image}
      ...
      <div className="p-5">
        ...
        <h3 className="mt-2 text-xl font-extrabold tracking-tight text-[#241b3f] transition group-hover:text-emerald-700">
          {event.title}
        </h3>
        ...
        <div className="mt-5 flex items-center justify-between border-t border-[#241b3f]/10 pt-4">
